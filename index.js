...
(async () => {
    ...
    if (patchWords && messages.some((message) => patchWords.some((word) => message.includes(word)))) {
        version = "patch";
    } else
...
function getPackageJson() {
    ...
    if (!existsSync(pathToPackage)) {
        throw new Error(packageJSONFileName + " could not be found in your project's root.");
    }
